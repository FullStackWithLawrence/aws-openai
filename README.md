...
- [Terraform](https://www.terraform.io/). See [Getting Started With AWS and Terraform](./doc/terraform-getting-started.md)
- [OpenAI platform API key](https://platform.openai.com/). See [How to Get an OpenAI API Key](./doc/openai-api-key.md)
